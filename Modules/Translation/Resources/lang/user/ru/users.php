...
return [
    ...
    'account not validated' => 'Ваш аккаунт не подтвержден. Пожалуйста проверьте свою почту и пройдите по ссылке из почты.',
    'account is blocked' => 'Ваш аккаунт заблокирован на :delay секунд.',
];
